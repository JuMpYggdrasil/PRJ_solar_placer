...
class AreaMeasurementApp:
    def __init__(self, master, image_path):
        ...
        new_size = (int(self.original_image.width / 2), int(self.original_image.height / 2))
        ...
        self.calculate_button1 = tk.Button(self.master, text="Jinko 550W", command=self.calculate_rectangle1,
                                          state=tk.DISABLED)
        self.calculate_button1.pack()

         # Create a button to calculate rectangle properties (initially disabled)
        self.calculate_button2 = tk.Button(self.master, text="Jinko 600W", command=self.calculate_rectangle2,
                                          state=tk.DISABLED)
        self.calculate_button2.pack()

        # Create a label to display the total number of rectangles
        self.total_rectangles_label = tk.Label(self.master, text="Total Rectangles: 0")
        self.total_rectangles_label.pack(side=tk.BOTTOM)
    ...
    def draw_rotated_rectangle(self, center, size, angle, color="lightblue"):
        ...
        self.canvas.create_polygon(x1, y1, x2, y2, x3, y3, x4, y4, fill=color, stipple="gray50")
    ...
    def draw_small_rectangles(self, center, size, angle,panel):
        ...
        gap_width = 0.4/self.scale_factor # unit: meter
        gap_height = 0.4/self.scale_factor
        ...
        for i in range(num_rectangles_horizontal):
            for j in range(num_rectangles_vertical):
                ...
                self.draw_rotated_rectangle(each_center, small_size, angle,color="darkblue")
                
                # x1, y1 = rotated_x1 - 1, rotated_y1 - 1
                # x2, y2 = rotated_x1 + 1, rotated_y1 + 1
        ...
        self.total_rectangles_label.config(text=f"panel: {num_rectangles_total} , kWp: {kW_total}")
    ...
    def calculate_rectangle1(self):
        ...
        self.draw_small_rectangles(center, size, angle,(550,1.134,2.278))
    ...
    def calculate_rectangle2(self):
        ...
        # Draw the rotated rectangle on the canvas
        self.draw_rotated_rectangle(center, size, angle)
        self.draw_small_rectangles(center, size, angle,(600,1.134,2.465))
